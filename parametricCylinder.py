...
#constructor params, radius and height of cylinder
#getPoint creates matrix holding specific shape equations
class parametricCylinder(parametricObject):

    def __init__(self,T=matrix(np.identity(4)),height=10.0,radius=10.0,
                 color=(255,255,255),reflectance=(0.2,0.4,0.4,1.0),uRange=(0.0,1),
                 vRange=(0.0,2.0*pi),uvDelta=(pi/18.0,pi/18.0)):
